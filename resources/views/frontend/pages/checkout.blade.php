...
@section('main-content')
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @endphp
                                            @if(session('coupon'))
                                                <li class="last"  id="order_total_price">Total<span>{{number_format($total_amount,2)}} THB</span></li>
                                            @else
                                                <li class="last"  id="order_total_price">Total<span>{{number_format($total_amount,2)}} THB</span></li>
                                            @endif
                                        </ul>
    ...
    <div class="checkbox">
        ...
        <form-group>
            ...
            <input name="payment_method"  type="radio" value="pay" required> <label> พร้อมเพย์ </label><br>
