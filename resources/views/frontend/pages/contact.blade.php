						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>รับการติดต่อ</h4>
									<h3>เขียนข้อความถึงเรา @auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="ชื่อ - นามสกุล">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>หัวข้อ<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="หัวข้อ">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>อีเมล<span>*</span></label>
												<input name="email" type="email" id="email" placeholder="อีเมล">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>เบอร์โทร<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="เบอร์โทร">
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>ข้อความ<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="ข้อความ"></textarea>
											</div>
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">เบอร์โทรติดต่อ:</h4>
									<ul>
								...
								<div class="single-info">
									...
									<h4 class="title">ที่อยู่ติดต่อ:</h4>
									<ul>
