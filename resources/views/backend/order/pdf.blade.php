    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,2)}} THB</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{number_format($order->sub_total,2)}} THB</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>{{number_format($shipping_charge[0],2)}} THB</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
