        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <h2>ผู้นำด้านความปลอดภัย</h2>
                </div>
                <h2 class="uppercase" style="font-size: 22px;">ศูนย์รวมอุปกรณ์เซฟตี้
                    อุปกรณ์นิรภัยส่วนบุคคล ครบวงจร</h2><br>
                  <p class="myfont">&nbsp;&nbsp;&nbsp;&nbsp;มีให้เลือกมากกว่า 1,000 รายการ
                    เราเป็นผู้นำเข้าและจำหน่าย อุปกรณ์เซฟตี้ อุปกรความปลอดภัยส่วนบุคคล คุณภาพดี มาตรฐานสากล</p>
                  <p class="myfont">&nbsp;&nbsp;&nbsp;&nbsp;อาทิเช่น รองเท้าเซฟตี้, หมวกนิรภัย, แว่นตาเซฟตี้,
                    ถุงมือกันสารเคมี, ชุดกันสารเคมี,หน้ากากกันสารพิษ, อุปกรณ์กันตก, อุปกรณ์เซฟตี้ Cleanroom และ
                    ESD Products และอุกรณ์ความปลอดภัยอื่น ๆ
                    โดยรวบรวมมาให้เลือกเพื่อตอบสนองทุกความต้องการด้านความปลอดภัย</p>
                  <h3 style="font-weight:bold;text-align:center;">เราคือ...ตัวแทนจำหน่ายผลิตภันฑ์ ระดับโลก
                    ชั้นนำแบบครบวงจร</h3>
                  <hr>
            </div>
        </div>
            ...
            <div class="single-product">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        <span><?php echo e(number_format($after_discount, 2)); ?> THB </span>
                        <del style="padding-left: 4%;"><?php echo e(number_format($product->price, 2)); ?> THB </del>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php $__currentLoopData = $product_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                                <div class="product-price">
                                    <span class="old"><?php echo e(number_format($product->price,2)); ?> THB </span>
                                    <?php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    ?>
                                    <span><?php echo e(number_format($after_discount,2)); ?> THB</span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                    <div class="quickview-content">
                                        ...
                                        <?php
                                            $after_discount=($product->price-($product->price*$product->discount)/100);
                                        ?>
                                        <h3><small><del class="text-muted"><?php echo e(number_format($product->price,2)); ?> THB </del></small>    <?php echo e(number_format($after_discount,2)); ?> THB  </h3>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ecommerce-Laravel\resources\views/frontend/index.blade.php ENDPATH**/ ?>