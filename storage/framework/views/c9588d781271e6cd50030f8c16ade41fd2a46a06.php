...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('group.store')); ?>" id="myForm"  >
        ...
        <input id="name_en" type="text" name="name_en" placeholder="Enter Name En"  value="<?php echo e(old('title')); ?>" class="form-control">
          ...
          <div class="form-group">
              ...
              <input id="name_th" type="text" name="name_th"  placeholder="Enter Name Th"  value="<?php echo e(old('title')); ?>" class="form-control">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ecommerce-Laravel\resources\views/backend/group/create.blade.php ENDPATH**/ ?>